...
function Edititem() {
    ...
    useEffect(() => {
        const barangRowdata = async () => {
            const getBarangData = await fetch("http://localhost/kotong-web-crud/api/barang.php/" + id);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.put("http://localhost/kotong-web-crud/api/barang.php", formData);
